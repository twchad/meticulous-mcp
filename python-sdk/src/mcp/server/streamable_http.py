...
class StreamableHTTPServerTransport:
    ...
    def _check_accept_headers(self, request: Request) -> tuple[bool, bool]:
        ...
        has_any = any(media_type == "*/*" for media_type in accept_types)

        has_json = has_any or any(media_type.startswith(CONTENT_TYPE_JSON) for media_type in accept_types)
        has_sse = has_any or any(media_type.startswith(CONTENT_TYPE_SSE) for media_type in accept_types)
